...
const Products = () => {
  ...
  const handleAdd = async () => {
    ...
    await axios
      .post('/upload-img-product', formData, {
        headers: {
        ...
        axios
          ...
          .then((response) => {
            ...
            const newdata = Object.assign({}, data, {
              id: response.data.productDetails.id,
            });
        ...
        <div className='edit-panel container'>
            ...
            <div className='col-md-6'>
              ...
              <div className='edit-panel__field'>
                ...
                <select
                  ...
                  value={
                    editedRows.category_name || selectedProduct.category_name
                  }
                  onChange={handleChangeCategory}
                >
                  {categories.map((category) => (
                    <option data-key={category.id} value={category.name}>
                      {category.name}
                    </option>
                  ))}
                </select>
              ...
              <div className='edit-panel__field'>
                ...
                >
                  {brands.map((brand) => (
                    <option data-key={brand.id} value={brand.id}>
                      {brand.name}
                    </option>
                  ))}
                </select>
              ...
              <div className='edit-panel__field'>
                ...
                <input
                  ...
                  type='number'
                  value={
                    editedRows.inventory_quantity !== undefined
                      ? editedRows.inventory_quantity
          ...
          <div className='edit-panel__buttons'>
            <Button
              ...
              color='primary'
              onClick={handleSave}
              style={{ marginRight: '15px', marginTop: '16px' }}
            >
              Lưu
            </Button>
            <Button
